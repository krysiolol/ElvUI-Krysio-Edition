...
L["Power"] = true
L["Powers"] = true
L["Prevent Multi-Channel Spam"] = true
...
L["When a player posts the same message across multiple public channels (e.g. /1, /2, /4) at the same time, only display it once in the first channel."] = true
