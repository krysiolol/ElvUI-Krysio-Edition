...
local CAN_HAVE_CLASSBAR = true -- Grimfall: runes for everyone, no class detection
...
function UF:Construct_PlayerFrame(frame)
	...
	do
		-- Grimfall is a classless server: every character is flagged DRUID but has the
		-- Death Knight rune resource. Always build the rune bar with no class detection.
