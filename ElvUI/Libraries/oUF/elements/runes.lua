...
-- Grimfall: classless server (everyone flagged DRUID) but all characters have runes.
-- Register the element for everyone; only bail if the rune API is unavailable.
